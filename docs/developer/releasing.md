...
* Update the following documentation to refer to the current release version:
  ...
  - [docs/developer/integration-tests.md](./integration-tests.md), update the test data URLs in the `git clone` commands with the intended URL for the test data repository (`https://github.com/riboviz/test-data-<TAG>`).
* Update `README.md`:
