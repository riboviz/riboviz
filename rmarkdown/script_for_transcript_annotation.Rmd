...
```{r, eval=FALSE}
# Download annotations from here - https://www.gencodegenes.org/releases/21.html
mouse_annot <- readGFFAsGRanges("/data/riboseq/Supp/seqs/mouse/vm14_current/gencode.vM14.annotation.gff3.gz")
...
# Read in Appris list
appris <- read.table("/data/riboseq/Supp/seqs/mouse/vm14_current/mouse_appris_data.principal.txt")
...
# Read in CDNA sequences
cdna_all <- readDNAStringSet("/data/riboseq/Supp/seqs/mouse/vm14_current/Mus_musculus.GRCm38.cdna.all.fa")
cdna_names <- sapply(strsplit(names(cdna_all)," "), `[`, 1)
names(cdna_all) <- sapply(strsplit(cdna_names,"\\."), `[`, 1)
...
cds_annot <- mouse_annot[mouse_annot$type=="CDS"]
