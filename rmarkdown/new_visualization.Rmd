...
yamlfilepath <- here::here(params$yamlfile)
```
...
# > str(read_counts_df)
# tibble [24 × 5] (S3: spec_tbl_df/tbl_df/tbl/data.frame)
...
```{r}
# apply the function
sample_dir_names <- find_sample_names(yaml1)  # @John Q: should this be a more generic value, or is yaml1 hardcoded for a reason?
