...
# plot read frame
if (!is.na(asite_disp_length)){
  #PlotGeneReadFrames(gene_read_frames_data)
  # TODO currently running str() because the PlotGeneReadFrames() needs an extra parameter
  # and it doesn't just PLOT, it does something extra to the gene_read_frames_data object first
  # so loading & plotting won't work just now
  str(gene_read_frames_data)
}
```
