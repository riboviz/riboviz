...
shinyUI<-fixedPage(
  ...
  fixedRow(
    column(4, #id='sidebar',
           textInput(inputId = 'localadd',label='Write the local address where the "localRibo" folder is stored'),
           actionButton(inputId = 'clicklocal',label='Click to confirm'),
           br(),
           br(),
           conditionalPanel(
             condition='input.clicklocal!=0',
