        ...
        if nmismatch > 0 & options.fivepremove:
            ...
            if ( MDtag[0]=="0" ) & (read.flag==0) :
                ...
                if ( not "S" in cigarstring[:3] ) :
                    ...
                    newinitbit = "1S" + str( ninitmatch - 1 ) + "M"
                    ...
                    newinitbit = str( nsoftclip + 1 ) + "S" + str( ninitmatch - 1 ) + "M"
            ...
            if ( bool( re.search( "[ATCG]0$", MDtag ) ) ) & (read.flag==16) :
                ...
                if ( cigarstring[-1] != "S" ) :
                    ...
                    # add initial "1S" and reduce initial match by 1
                    newtermbit = str( ntermmatch - 1 ) + "M1S"
                    ...
                    # add initial "1S" and reduce initial match by 1
                    newtermbit = str( ntermmatch - 1 ) + "M" + str( nsoftclip + 1 ) + "S"
