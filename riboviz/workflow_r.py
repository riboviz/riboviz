...
""" ``generate_stats_figs.R`` output file. """
READ_COUNTS_BY_LENGTH_TSV = "read_counts_by_length.tsv"
""" ``generate_stats_figs.R`` output file. """
READ_COUNTS_BY_LENGTH_PDF = "read_counts_by_length.pdf"
""" ``generate_stats_figs.R`` output file. """
NT_FREQ_PER_READ_POSITION_TSV = "nt_freq_per_read_position.tsv"
""" ``generate_stats_figs.R`` output file. """
...
""" ``generate_stats_figs.R`` output file. """
READ_FRAME_PER_ORF_TSV = "read_frame_per_ORF.tsv"
""" ``generate_stats_figs.R`` output file. """
...
""" ``generate_stats_figs.R`` output file. """
METAGENE_POSITION_LENGTH_COUNTS_TSV = "metagene_position_length_counts_5start.tsv"
""" ``generate_stats_figs.R`` output file. """
