"""
Test Nextflow workflow using configuration with barcode and UMI
extraction, demultiplexing, and deduplication.
...
demultiplexing and deduplication against the expected outputs,
...
def test_deplex_umi_groups(configuration_module, sample_id):
    ...
    :py:func:`riboviz.test.nextflow.test_simdata_umi.check_umi_groups`.
...
def test_deplex_tpms_collated_tsv(configuration_module, sample_id):
    ...
    :py:func:`riboviz.test.nextflow.test_simdata_umi.check_tpms_collated_tsv`.
