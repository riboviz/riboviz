...
def test_count_sequences(test_case, file_type):
    ...
    :param test_case: Test case with test SAM/BAM file name prefix (to
    which ".file_type" will be appended, and a tuple with the expected
    number of sequences and expected number of mapped (primary)
    sequences).
