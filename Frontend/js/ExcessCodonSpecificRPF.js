...
var datanew = data; 
				...
				legendSpace5 =  widthFigure5/nucleotide.length;
  				...
  				yFigure5.domain([-2,d3.max(datanew, function(d) { return d.Mean+d.SD; })]);
...
var lineSvg5=freqFigure5.enter().append("g").attr("class", "nucleotide");
      ...
      lineSvg5.append("text")
				...
				.attr("transform", function(d, i) { return "translate(" + ((widthFigure5-paddingFigure5l*0.5)) + "," + ((legendSpace5/7)+i*legendSpace5/7)+ ")"; })
