...
var xFigure4 = d3.scale.linear()
    ...
    .y0(function(d) { return yFigure4(d.Reads+d.SD); })
    .y1(function(d) { return yFigure4(d.Reads-d.SD); });

	var svglineFigure4 = d3.svg.line()
    	.x(function(d) { return xFigure4(d.Position); })
    	.y(function(d) { return yFigure4(d.Reads); });
...
var datanew = datanewfirst.filter(function(d, key) { 
            return (d.End==value2  & (d.BG==value3[0] | d.BG==value3[1] | d.BG==value3[2])); 
...
updateFigure4(data, d3.select('input[name="inputsrc51"]:checked').node().value, ["FF", "CHX", "Data"]);
    ...
    function changeit4() {
		...
		updateFigure4(data,  prime, ["FF", "CHX", "Data"]);
	};
