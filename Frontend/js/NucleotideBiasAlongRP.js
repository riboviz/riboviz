...
var marginFigure3 = {top: 0, right: 60, bottom: 70, left: 100},
		paddingFigure3=5,
    	widthFigure3 =650 - marginFigure3.left - marginFigure3.right,
...
// now add titles to the axes
       ...
       svgFigure3.append("text")
            .attr("text-anchor", "middle")  // this makes it easy to centre the text as the transform is applied to the anchor
            .attr("transform", "translate("+ (widthFigure3/2) +","+(heightFigure3+paddingFigure3*6)+")")  // centre below axis
...
var freqFigure3 = svgFigure3.selectAll(".nucleotide")
 ...
 updateFigure3(data, d3.select('input[name="inputsrc1"]:checked').node().value, d3.select("#nValue").node().value, 100);   
