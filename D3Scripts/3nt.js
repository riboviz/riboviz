	...
	d3.tsv("../VizData/F1.tsv", function(error, data) {
...
var datanew = data.filter(function(d, key) { 
            return (d.Year==value1 & d.Author==value2 & d.Dataset==value3 & d.end==value4 ); //& d.CHX==value3
...
function change1() {
	...
	updateFigure1(data, year1,author1, thedataset1, 5);
	
	d3.select(document.getElementById("3prime"))
	.on("click", function() {
		updateFigure1(data, year1,author1, thedataset1, 3);
	});
