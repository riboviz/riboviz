...
var xFigure5 = d3.scale.linear()
	...
	d3.tsv("../VizData/F5_Temp.tsv", function(error, data) {
...
function updateFigure5(data, value1f, value2f, value3f, value1, value2, value3) {

var datanewfirst = data.filter(function(d, key) { 
            return ((d.Year==value1f  | d.Year=="All") & (d.Author==value2f  | d.Author=="All") & (d.Dataset==value3f  | d.Year=="All") ); 
...
var nucleotide = d3.nest()
 ...
 colorFigure5.domain(["Data", "non-CHX", "CHX", "Other"]);
 ...
 legendSpace = heightFigure5/nucleotide.length;
     ...
     .datum(function(d) { return {name: d.key, value: d.values[d.values.length - 1]}; })
			...
			//.attr("transform", "translate(" + (widthFigure5) + " ," + (heightFigure5 -paddingFigure5*5) + ")")
      		...
      		if(d.name==0 & value1=="RPF"){return "non-CHX"};
...
function change5() {
	...
	updateFigure5(data, year1,author1, thedataset1, "RPF",0, [0, 1, 100]);
    ...
    function changeit5() {
		...
		var datatype= d3.select('input[name="inputsrc52"]:checked').node().value;
		updateFigure5(data, year1,author1, thedataset1, datatype, prime, [0, 1, 100]);
	};
