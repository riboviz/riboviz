			...
			d3.tsv("../VizData/F2.tsv", function(error, data) {
	...
	function updateFigure2(data, value1, value2, value3) {


var datanew = data.filter(function(d, key) { 
            return (d.Year==value1 & d.Author==value2 & d.Dataset==value3 );
...
function change2() {
	...
	updateFigure2(data, year2,author2, thedataset2);
}; 
